...
const Hero = () => {
  return (
    <div className='w-full mb-10 flex max-md:grid-cols-1 max-md:flex-col-reverse'>
        <div className='flex flex-col gap-y-10'>
          ...
          <button className='bg-white text-black md:self-start self-center max-md:mb-10 w-32 h-14 sm:w-32 sm:h-12 sm:text-2xl lg:w-40 lg:h-16 rounded-2xl lg:text-2xl font-lato md:ml-10'>
            Explore
          </button>
        </div>
